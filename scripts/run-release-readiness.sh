...
bash -n scripts/test-winget-publishing.sh scripts/prepare-winget-submission.sh scripts/submit-winget-release.sh scripts/test-winget-manifests.sh scripts/generate-winget-manifests.sh scripts/validate-winget-manifests.sh scripts/test-release-tools.sh scripts/run-scale-validation.sh scripts/sign-release-artifact.sh scripts/sync-signing-key.sh \
